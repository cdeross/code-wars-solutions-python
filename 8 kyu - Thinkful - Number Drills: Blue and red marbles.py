...
and then pulling one marble out. You get a point if you guessed correctly. The trick is you only have three seconds to
make your guess, so you have to think quickly.
...
def guess_blue(blue_start, red_start, blue_pulled, red_pulled):
    return float((blue_start - blue_pulled) / ((blue_start + red_start) - (blue_pulled + red_pulled)))
